...
public class GoogleMercatorLayer extends BasicMercatorTiledImageLayer{
    ...
    private static LevelSet makeLevels(String name) {
       ...
       // params.setValue(AVKey.BOUNDS,10);
        ...
        switch (name) {
            case GOOGLE_TERRAIN:
                ...
                params.setValue(AVKey.SERVICE, "http://www.google.com/maps/vt?lyrs=t");
            ...
            case GOOGLE_TERRAIN_LABEL_ZH:
                ...
                params.setValue(AVKey.SERVICE, "http://www.google.com/maps/vt?lyrs=p");
                params.setValue(AVKey.LAYER_NAME, "terrainlabel");
                break;
            case GOOGLE_SATE:
                params.setValue(AVKey.DATA_CACHE_NAME, "Google/MercatorSate");
                params.setValue(AVKey.SERVICE, "http://www.google.com/maps/vt?lyrs=s");
    ...
    private static class URLBuilder implements TileUrlBuilder
    {
                ...
                throws MalformedURLException
        {
            ...
            String url=String.format(
                    serverUrl + "@725&gl=com&x=%s&y=%s&z=%s",
