...
while(true){
 ...
 /*       LinkedList<Position> list = new LinkedList<Position>();
        list.add(Position.fromDegrees(39.36348, 27.55525, 6000));//first geo point
        list.add(Position.fromDegrees(39.751, 44.386, 6000));//second geo point
        list.add(Position.fromDegrees(36.751, 35.386, 6000));//third geo point
        list.add(Position.fromDegrees(39.36348, 27.55525, 6000));//again first point
        Polyline polyline = new Polyline(list);
        polyline.setColor(Color.RED);
        polyline.setLineWidth(3.0);
        layer.addRenderable(polyline);
        WorldWindowGLCanvas.getModel().getLayer s().add(layer);*/
