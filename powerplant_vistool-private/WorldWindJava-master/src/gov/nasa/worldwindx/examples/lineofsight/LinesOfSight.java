 ...
 */
public class LinesOfSight extends BuildingApp
{
    ...
    public static class AppFrame extends BuildingApp.AppFrame
    {
    ...
    public static void main(String[] args)
    {
        ...
        BuildingApp.start("World Wind Terrain Intersections", AppFrame.class);
    }
}