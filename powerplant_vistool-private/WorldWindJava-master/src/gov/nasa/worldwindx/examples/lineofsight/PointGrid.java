...
public class PointGrid extends WWObjectImpl implements OrderedRenderable, Highlightable
{
    ...
    public void setPositions1(Iterable<? extends Position> positions)
    {
    ...
    public void render(DrawContext dc)
    {
       ...
       if (dc.isOrderedRenderingMode()){
         ...
         //   System.out.println("isOrderedRenderingMode");
    ...
    protected void drawPoints(DrawContext dc)
    {
        ...
        gl.glDrawArrays(GL.GL_POINTS, 0, this.currentPoints.limit() );
    ...
    protected void setPointSize(DrawContext dc, Double size)
    {
        ...
        {
            gl.glDisable(GL2.GL_POINT_SMOOTH);//.glEnable(GL2.GL_POINT_SMOOTH);
