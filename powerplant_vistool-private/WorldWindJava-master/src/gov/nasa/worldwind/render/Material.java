...
public class Material
{
    ...
    public static final Material GRAY = new Material(Material.makeDarker(Color.GRAY));
    ...
    protected static Color makeDarker(Color color)
    {
        ...
        float factor1 = 0.2126f;
        float factor2 =  0.7152f;
        float factor3 =   0.0722f;
        int r = color.getRed();
...
//System.out.println(a);
    /*    return new Color(
            Math.max(0, (int) (r * factor1)),
            Math.max(0, (int) (g * factor2)),
            Math.max(0, (int) (b * factor3)),
            128);*/
int gg1=Math.max(r, g);
gg1=Math.max(gg1,b);
int gg2=Math.min(r, g);
gg2=Math.min(gg2,b);
int gg=(gg1+gg2)/2;
//System.out.println((int) (r * factor1)+" "+(int) (g * factor2)+" "+(int) (b * factor3)+" "+128);
//System.out.println((int) (r * 1)+" "+(int) (g * 1)+" "+(int) (b * 1)+" "+128);
return new Color(gg,gg,gg,128);
    }
