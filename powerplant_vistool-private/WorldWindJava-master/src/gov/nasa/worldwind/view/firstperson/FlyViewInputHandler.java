...
public class FlyViewInputHandler extends BasicViewInputHandler
{
    ...
    protected static final double DEFAULT_KEY_HORIZONTAL_TRANSLATE_MAX_VALUE = 10000.0;
    ...
    protected static double DEFAULT_MOUSE_HORIZONTAL_TRANSLATE_MAX_VALUE = 10000.0;
    ...
    protected static final double DEFAULT_MOUSE_WHEEL_VERTICAL_TRANSLATE_VALUE_MIN_OSX = 100000;
    ...
    protected static final double DEFAULT_MOUSE_WHEEL_VERTICAL_TRANSLATE_VALUE_MAX_OSX = 900000;
        // Speed in log-meters per wheel movement
    protected static final double DEFAULT_MOUSE_WHEEL_VERTICAL_TRANSLATE_VALUE_MIN = 100000;
        // Speed in log-meters per wheel movement
...
//
        ...
        ViewInputAttributes.ActionAttributes actionAttribs)
    {
       ...
       // System.out.println("smothing"+smoothing);
    ...
    {
       Angle forwardChange=Angle.ZERO;
        Angle sideChange;
