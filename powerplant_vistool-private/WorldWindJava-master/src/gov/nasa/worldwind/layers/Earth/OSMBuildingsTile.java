...
//	static final String OSMBUILDINGS_URL =" ";
    ...
    public OSMBuildingsTile(int level, int x, int y, OSMBuildingsTileListener listener, LatLon center2,
...
System.out.println(OSMBuildingsLayer.CACHE_FOLDER + File.separatorChar + level + File.separatorChar + x
        ...
        */
        this. lat1 = OSMBuildingsLayer.y2lat(y + 1, OSMBuildingsLayer.ZOOM);
        this. lon1 = OSMBuildingsLayer.x2lon(x, OSMBuildingsLayer.ZOOM);
        this. lat2 = OSMBuildingsLayer.y2lat(y, OSMBuildingsLayer.ZOOM);
        this. lon2 = OSMBuildingsLayer.x2lon(x + 1, OSMBuildingsLayer.ZOOM);
        ...
        att.setInteriorOpacity(1.0);
        att.setEnableLighting(false);
        att.setOutlineMaterial(Material.BLACK);
        att.setOutlineWidth(1d);
        att.setInteriorMaterial(Material.BLACK);
        att.setDrawInterior(false);
        att.setDrawOutline(true);
        att.setOutlineWidth(4.0);
       // att.
    ...
    public void fetch()
    {
        try
        {
           ...
           // String s = "https://[abcd].data.osmbuildings.org/0.2/sx3pxpz6/tile/${Z}/${X}/${Y}.json";
          
            String s = "https://[abcd].data.osmbuildings.org/0.2/anonymous/tile/${Z}/${X}/${Y}.json";
